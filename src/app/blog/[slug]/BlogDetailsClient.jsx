  ...
  if (!article) {
    return (
      <div className="min-h-screen bg-[#E2D8A5] text-stone-900 flex flex-col items-center justify-center p-6 font-sans">
        ...
        <button onClick={() => handleNavigate("blog")} className="text-[#E7A35F] hover:underline font-mono uppercase tracking-widest text-xs">
          Back to Articles
        </button>
      </div>
    );
    ...
    <>
      ...
      <main className="relative z-10 pt-[80px] bg-[#E2D8A5] text-stone-900">
        <article className="max-w-4xl mx-auto px-6 py-16 sm:py-24">
          ...
          {/* Category badge */}
          <span className="text-[#E7A35F] text-xs font-mono tracking-[0.3em] font-bold uppercase block mb-4">
          ...
          <div className="flex flex-wrap items-center gap-6 pb-8 border-b border-stone-200/50 text-stone-500 text-xs sm:text-sm font-light mb-12">
            <div className="flex items-center space-x-2">
              <User size={14} className="text-[#E7A35F]" />
          ...
          <div className="mt-20 border-t border-stone-200/50 pt-16 text-center max-w-3xl mx-auto space-y-6">
            <div className="inline-flex items-center space-x-2 text-[#E7A35F]">
              <Sparkles size={16} />
            ...
            <h2 className="text-2xl sm:text-3xl font-serif text-stone-950 uppercase leading-snug">
              ...
              <span className="italic text-[#E7A35F] font-normal lowercase">Let's blueprint your custom spatial architecture.</span>
            </h2>
            ...
            <div className="pt-4">
              <button
                ...
                className="inline-flex items-center justify-center space-x-3 text-stone-900 font-bold text-xs tracking-widest uppercase transition-all duration-300 bg-[#E7A35F] hover:bg-[#6F9F9C] px-8 py-5 rounded-full cursor-pointer shadow-xl"
              >
