  ...
  if (!project) {
    return (
      <div className="min-h-screen bg-field text-stone-900 flex flex-col items-center justify-center p-6 font-sans">
        ...
        <button onClick={() => handleNavigate("home")} className="text-primary hover:underline font-mono uppercase tracking-widest text-xs">
          Back to Projects
        </button>
      </div>
    );
        ...
        <article className="max-w-8xl mx-auto px-6 py-16 sm:py-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16 items-start">
            <div className="lg:col-span-8 space-y-4 text-left">
              <span className="text-primary text-xs font-mono tracking-[0.3em] font-bold uppercase block">
                {project.category}
              </span>
            ...
            <div className="lg:col-span-4 bg-white border border-stone-200/50 p-6 rounded-2xl space-y-4 text-left shadow-sm">
              <h3 className="text-xs font-mono font-bold tracking-[0.2em] text-primary uppercase border-b border-stone-100 pb-2">
          ...
          <div className="mt-24 border-t border-stone-200/50 pt-16 flex flex-col sm:flex-row items-center justify-between gap-6">
            <button
              onClick={() => handleNavigate("gallery")}
              className="inline-flex items-center space-x-2 text-stone-800 hover:text-primary transition-colors cursor-pointer text-xs font-mono tracking-widest uppercase"
            >
              <ArrowLeft size={14} />
