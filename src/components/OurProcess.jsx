...
export default function OurProcess({ setView }) {
  ...
  return (
    <section id="our-process" className="bg-field py-24 md:py-32 relative overflow-hidden border-t border-stone-200/50">
      <div className="max-w-8xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="text-left max-w-3xl mb-20 md:mb-28 space-y-4">
          ...
          <h2 className="text-3xl md:text-5xl font-light tracking-tight text-stone-900 leading-tight uppercase">
            From Your Vision <br />
            <span className="font-serif italic text-primary font-normal lowercase">to a</span> Beautiful Reality.
          </h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute left-4 sm:left-1/2 top-6 -translate-x-1/2 z-20 flex items-center justify-center pointer-events-none">
                    <div className="w-8 h-8 rounded-full bg-white border border-stone-200 flex items-center justify-center shadow-sm group-hover:border-primary group-hover:scale-110 transition-all duration-300">
                  ...
                  <div className="w-full sm:w-[45%] pl-12 sm:pl-0">
                    <motion.div
                      whileHover={{ y: -4 }}
                      className="bg-white border border-stone-200/60 p-6 md:p-8 rounded-lg shadow-sm hover:shadow-md hover:border-primary/30 transition-all duration-500 group flex flex-col justify-between h-full text-left"
                    >
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-xs font-mono font-bold text-stone-400 group-hover:text-primary transition-colors duration-300">
                            STEP {step.num}
                          </span>
                        </div>
        ...
        >
          ...
          <div className="max-w-3xl relative z-10 space-y-6">
            ...
            <h3 className="text-2xl md:text-4xl font-light tracking-tight text-white leading-tight uppercase">
              ...
              <span className="font-serif italic text-primary font-normal lowercase">Dream Project</span>?
            </h3>
