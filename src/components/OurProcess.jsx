      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="text-left max-w-3xl mb-20 md:mb-28 space-y-4">
          ...
          <h2 className="text-3xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-stone-900 leading-tight">
            From Your Vision <br />
            <span className="text-[#CAA05C]">To A Beautiful Reality.</span>
          </h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute left-4 sm:left-1/2 top-6 -translate-x-1/2 z-20 flex items-center justify-center pointer-events-none">
                    <div className="w-8 h-8 rounded-full bg-white border border-stone-200 flex items-center justify-center shadow-sm group-hover:border-[#CAA05C] group-hover:scale-110 transition-all duration-300">
                      <span className="text-[10px] font-bold text-[#CAA05C] font-mono">{step.num}</span>
                    </div>
                  </div>
                  ...
                  <div className="w-full sm:w-[45%] pl-12 sm:pl-0">
                    <motion.div
                      whileHover={{ y: -4 }}
                      className="bg-white border border-stone-200/60 p-6 md:p-8 rounded-lg shadow-sm hover:shadow-md hover:border-[#CAA05C]/30 transition-all duration-500 group flex flex-col justify-between h-full text-left"
                    >
                      <div className="space-y-4">
                        {/* Card Header with Icon */}
                        <div className="flex items-center justify-between">
                          <div className="w-10 h-10 rounded-lg bg-stone-50 group-hover:bg-[#CAA05C]/10 flex items-center justify-center text-stone-800 group-hover:text-[#CAA05C] transition-colors duration-500 border border-stone-100 group-hover:border-[#CAA05C]/20">
                            <IconComponent className="w-5 h-5 transition-transform duration-500 group-hover:scale-110" />
                          </div>
                          <span className="text-xs font-mono font-bold text-stone-400 group-hover:text-[#CAA05C] transition-colors duration-300">
                            STEP {step.num}
                          </span>
                        </div>
                        ...
                        <div className="space-y-2">
                          <h3 className="text-lg font-serif font-medium text-stone-950 group-hover:text-[#CAA05C] transition-colors duration-300">
                            {step.title}
                          </h3>
        ...
        >
          ...
          <div className="absolute right-0 bottom-0 w-[40%] h-[100%] bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-[#CAA05C]/15 via-stone-950/0 to-stone-950/0 opacity-80 pointer-events-none" />
          ...
          <div className="max-w-3xl relative z-10 space-y-6">
            ...
            <h3 className="text-2xl md:text-4xl font-light tracking-tight text-white leading-tight uppercase">
              ...
              <span className="text-[#CAA05C]">Dream Project</span>?
            </h3>
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-4 sm:items-center">
              ...
              >
                ...
                <div className="w-8 h-8 rounded-full border border-stone-950/20 bg-stone-950/10 flex items-center justify-center text-stone-950 group-hover:bg-stone-950 group-hover:text-[#CAA05C] transition-all duration-300">
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.02, borderColor: "#CAA05C", color: "#CAA05C" }}
                whileTap={{ scale: 0.98 }}
