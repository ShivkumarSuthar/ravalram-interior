...
const transitionLuxury = "/assets/images/AI_images/antra_transition_luxury_1782747459033.jpg";
    ...
    <div className="min-h-screen bg-stone-950 text-white font-sans flex flex-col justify-between relative overflow-hidden selection:bg-gold-accent selection:text-stone-950">
      ...
      <header className="relative z-20 max-w-7xl w-full mx-auto px-6 py-8 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <span className="text-xl md:text-2xl font-serif tracking-[0.2em] font-light text-white uppercase">
            SUTHAR<span className="text-gold-accent font-normal">.</span>
          </span>
        </div>
      ...
      <main className="relative z-20 flex-1 flex flex-col items-center justify-center text-center px-6 py-12 max-w-4xl mx-auto w-full">
        ...
        >
          ...
          <div className="inline-flex items-center space-x-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md">
            ...
            <span className="text-[9px] font-mono font-bold tracking-[0.2em] uppercase text-gold-accent">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-light tracking-tight text-white leading-none uppercase">
            WE ARE <br />
            <span className="text-gold-accent">LAUNCHING</span> SOON
          </h1>
        ...
        >
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 backdrop-blur-md flex flex-col items-center justify-center space-y-1">
            <span className="text-3xl sm:text-5xl font-serif font-light text-gold-accent">
        ...
        >
          <div className="space-y-1 text-left">
            <h4 className="text-xs uppercase tracking-wider font-bold text-white flex items-center gap-1.5">
              <Mail size={13} className="text-gold-accent" />
          ...
          <AnimatePresence>
            {isSubscribed && (
              <motion.div
                ...
                className="flex items-center space-x-2 text-gold-accent text-[10px] font-mono tracking-wider text-left bg-gold-accent/10 p-3 rounded-lg border border-gold-accent/20"
              >
      ...
      <footer className="relative z-20 max-w-7xl w-full mx-auto px-6 py-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-4">
          <a href="#instagram" className="w-8 h-8 rounded-full bg-white/5 hover:bg-gold-accent hover:text-stone-950 text-stone-400 flex items-center justify-center transition-all">
            <Instagram size={14} />
          </a>
          <a href="#twitter" className="w-8 h-8 rounded-full bg-white/5 hover:bg-gold-accent hover:text-stone-950 text-stone-400 flex items-center justify-center transition-all">
            <Twitter size={14} />
          </a>
          <a href="#facebook" className="w-8 h-8 rounded-full bg-white/5 hover:bg-gold-accent hover:text-stone-950 text-stone-400 flex items-center justify-center transition-all">
            <Facebook size={14} />
          </a>
          <a href="#linkedin" className="w-8 h-8 rounded-full bg-white/5 hover:bg-gold-accent hover:text-stone-950 text-stone-400 flex items-center justify-center transition-all">
            <Linkedin size={14} />
          </a>
        </div>
      </footer>
