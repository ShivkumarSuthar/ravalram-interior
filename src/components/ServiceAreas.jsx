...
export default function ServiceAreas() {
  ...
  return (
    <section id="service-areas" className="bg-field py-24 md:py-32 relative overflow-hidden border-t border-stone-200/50">
      <div className="max-w-8xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="text-left max-w-3xl mb-16 md:mb-24 space-y-4">
          ...
          <h2 className="text-3xl md:text-5xl font-light tracking-tight text-stone-900 leading-tight uppercase">
            ...
            <span className="font-serif italic text-primary font-normal lowercase">Across</span> India.
          </h2>
        ...
        >
          {locations.map((loc, idx) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="bg-white border border-stone-200/60 p-6 md:p-8 rounded-xl text-left space-y-4 hover:shadow-xl hover:border-primary/30 transition-all duration-500 group flex flex-col justify-between"
            >
              <div className="space-y-4">
                {/* Location Icon pin with gold accents on hover */}
                <div className="w-10 h-10 rounded-lg bg-stone-50 group-hover:bg-primary/10 flex items-center justify-center text-stone-800 group-hover:text-primary transition-colors duration-500 border border-stone-100 group-hover:border-primary/20">
        ...
        >
          ...
          <div className="max-w-3xl relative z-10 space-y-6">
            ...
            <h3 className="text-2xl md:text-4xl font-light tracking-tight text-white leading-tight uppercase">
              ...
              <span className="font-serif italic text-primary font-normal lowercase">Outside These</span> Cities?
            </h3>
            ...
            {highlights.map((high, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white border border-stone-200/40 p-6 rounded-xl text-left space-y-4 hover:shadow-md hover:border-primary/20 transition-all duration-500 group"
                >
                  <div className="w-9 h-9 rounded-lg bg-stone-50 border border-stone-100 flex items-center justify-center text-primary group-hover:bg-primary/10 transition-colors duration-300">
                    <HighIcon size={16} />
                  </div>
                  <div className="space-y-1.5">
                    <h4 className="text-xs font-bold uppercase tracking-wider text-stone-900 group-hover:text-primary transition-colors duration-300 font-sans">
                      {high.title}
                    </h4>
