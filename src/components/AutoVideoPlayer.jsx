    ...
    <section className="relative w-full bg-[var(--color-surface-dark)] overflow-hidden leading-none select-none border-t border-b border-stone-800/80">
      ...
      <div className="relative w-full h-[380px] sm:h-[500px] md:h-[600px] lg:h-[700px] flex items-center justify-center bg-black overflow-hidden">
        ...
        <div className="absolute inset-0 z-10 flex items-center justify-center pointer-events-none">
          ...
          >
            <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-stone-900/40 border border-white/30 flex items-center justify-center group-hover:bg-gold-accent group-hover:text-stone-950 transition-all duration-300">
              {isPlaying ? (
        ...
        <div className="absolute top-6 right-6 z-20 flex items-center space-x-3">
          ...
          <button
            onClick={toggleMute}
            className="w-10 h-10 rounded-full bg-black/60 hover:bg-gold-accent text-white hover:text-stone-950 flex items-center justify-center backdrop-blur-md border border-white/20 transition-all duration-300 shadow-xl cursor-pointer"
          ...
          <button
            ...
            className="w-10 h-10 rounded-full bg-black/60 hover:bg-gold-accent text-white hover:text-stone-950 flex items-center justify-center backdrop-blur-md border border-white/20 transition-all duration-300 shadow-xl cursor-pointer hidden sm:flex"
            title="Fullscreen"
