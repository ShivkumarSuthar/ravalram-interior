...
export default function BlogPage({ onBackToHome, onOpenQuote }) {
  ...
  return (
    <div className="bg-[#E2D8A5] text-stone-900 font-sans selection:bg-[#E7A35F]/30 selection:text-stone-950 pt-[80px] overflow-hidden">
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-stone-950 text-white" id="blog-hero">
        ...
        <div className="max-w-8xl mx-auto px-6 md:px-12 relative z-20 w-full text-left space-y-8 py-20">
          <div className="inline-flex items-center space-x-2 text-stone-400 text-xs tracking-[0.25em] font-mono uppercase">
            ...
            <span>/</span>
            <span className="text-[#E7A35F] font-bold">JOURNAL</span>
          </div>
          ...
          <div className="space-y-4 max-w-4xl">
            ...
            >
              Ideas That <br />
              <span className="font-serif italic text-[#E7A35F] font-normal lowercase">Inspire Better</span> Spaces.
            </motion.h1>
            <motion.p
      ...
      <section className="py-24 bg-white border-b border-stone-100" id="featured-article">
        <div className="max-w-8xl mx-auto px-6 md:px-12">
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between border-b border-stone-200/60 pb-8 mb-16">
            <div className="text-left space-y-3">
              ...
              <h2 className="text-3xl md:text-5xl font-light tracking-tight text-stone-900 uppercase">
                The Master <span className="font-serif italic text-[#E7A35F] font-normal lowercase">Colleague</span>
              </h2>
            </div>
          ...
          <div className="bg-[#E2D8A5] rounded-3xl overflow-hidden border border-stone-200/40 shadow-sm hover:shadow-2xl transition-all duration-500">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 items-stretch">
              ...
              >
                <AppImage
                  ...
                  referrerPolicy="no-referrer"
                />
                <div className="absolute top-6 left-6 bg-stone-950 text-[#E7A35F] font-mono text-[10px] font-bold uppercase tracking-widest px-3.5 py-2 shadow-lg">
                  {featuredArticle.categoryLabel}
                </div>
                <div className="absolute bottom-6 right-6 w-12 h-12 rounded-full bg-white/10 backdrop-blur-md text-white flex items-center justify-center border border-white/20 group-hover:bg-[#E7A35F] group-hover:text-stone-950 transition-all duration-300">
                  <Maximize2 size={16} />
                </div>
              </div>
              ...
              <div className="lg:col-span-5 p-8 md:p-12 flex flex-col justify-between text-left bg-white">
                <div className="space-y-6">
                  <div className="flex items-center space-x-4 text-[11px] font-mono font-bold text-stone-400 uppercase tracking-widest">
                    <span className="flex items-center space-x-1.5">
                      <Calendar size={12} className="text-[#E7A35F]" />
                      <span>{featuredArticle.date}</span>
                    </span>
                    <span>&bull;</span>
                    <span className="flex items-center space-x-1.5">
                      <Clock size={12} className="text-[#E7A35F]" />
                  ...
                  <h3 
                    onClick={() => setActiveArticle(featuredArticle)}
                    className="text-2xl sm:text-3xl md:text-4xl font-light font-serif tracking-tight text-stone-950 hover:text-[#E7A35F] transition-colors cursor-pointer leading-tight uppercase"
                  >
                ...
                <div className="pt-8 mt-8 border-t border-stone-100 flex items-center justify-between">
                  <div className="flex items-center space-x-2 text-xs font-semibold text-stone-700">
                    <div className="w-8 h-8 rounded-full bg-stone-100 border border-stone-200/50 flex items-center justify-center text-[#E7A35F] font-mono text-xs">
                      ES
                    </div>
                  ...
                  <button
                    onClick={() => setActiveArticle(featuredArticle)}
                    className="inline-flex items-center space-x-2.5 text-xs font-bold font-mono tracking-widest uppercase text-stone-900 hover:text-[#E7A35F] transition-colors cursor-pointer group"
                  >
      ...
      {/* ==================================================== */}
      <section ref={articlesSectionRef} className="py-12 bg-[#E2D8A5] border-b border-stone-100 sticky top-[80px] z-30 shadow-sm" id="articles-section">
        <div className="max-w-8xl mx-auto px-6 md:px-12 flex flex-col xl:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center space-x-2.5 text-stone-400 font-mono text-[10px] sm:text-xs tracking-widest uppercase shrink-0">
            <Sliders size={14} className="text-[#E7A35F]" />
              ...
              <button
                ...
                className={`px-4.5 py-2.5 text-[11px] font-mono font-bold uppercase tracking-widest transition-all duration-300 rounded-none border whitespace-nowrap cursor-pointer ${
                  selectedCategory === tab.id
                    ? "bg-stone-950 text-[#E7A35F] border-stone-950 shadow-md scale-95"
                    : "bg-white text-stone-600 border-stone-200/80 hover:border-[#E7A35F]/50 hover:text-stone-950"
                }`}
              >
                {tab.label}
              </button>
        ...
        <div className="max-w-8xl mx-auto px-6 md:px-12">
          ...
          <div className="flex justify-between items-center mb-10 border-b border-stone-100 pb-4">
            ...
            <div className="hidden sm:flex items-center space-x-2 text-xs font-mono text-stone-400">
              <span className="w-1.5 h-1.5 rounded-full bg-[#E7A35F] animate-pulse" />
          ...
          {totalArticles === 0 ? (
            <div className="py-20 text-center space-y-4 bg-[#E2D8A5] rounded-3xl border border-dashed border-stone-200">
              ...
              <button 
                ...
                className="px-5 py-2.5 bg-stone-950 text-[#E7A35F] text-xs font-mono font-bold uppercase tracking-widest cursor-pointer hover:bg-stone-900 transition-colors"
              >
                Show All Articles
              </button>
            </div>
              ...
              <AnimatePresence mode="popLayout">
                {paginatedArticles.map((article) => (
                  <motion.article
                    ...
                    className="group bg-[#E2D8A5] border border-stone-200/30 rounded-2xl overflow-hidden hover:shadow-xl hover:bg-white transition-all duration-500 flex flex-col justify-between text-left"
                  >
                    <div className="space-y-6">
                      {/* Featured Image */}
                      <div 
                      ...
                      >
                        <AppImage
                          ...
                          referrerPolicy="no-referrer"
                        />
                        <div className="absolute top-4 left-4 bg-stone-950 text-[#E7A35F] font-mono text-[9px] font-bold uppercase tracking-widest px-2.5 py-1.5 shadow-md">
                      ...
                      <div className="px-6 space-y-3">
                        <div className="flex items-center space-x-3 text-[10px] text-stone-400 font-mono tracking-wider font-bold uppercase">
                          <span className="flex items-center space-x-1">
                            <Calendar size={11} className="text-[#E7A35F]" />
                            <span>{article.date}</span>
                          </span>
                          <span>&bull;</span>
                          <span className="flex items-center space-x-1">
                            <Clock size={11} className="text-[#E7A35F]" />
                        ...
                        <h3 
                          onClick={() => setActiveArticle(article)}
                          className="text-lg md:text-xl font-serif text-stone-900 group-hover:text-[#E7A35F] transition-colors duration-300 leading-snug cursor-pointer font-medium uppercase"
                        >
                          {article.title}
                        </h3>
                    ...
                    <div className="p-6 pt-4 mt-6 border-t border-stone-200/50 flex items-center justify-between">
                      <div className="flex items-center space-x-2 text-[11px] font-mono font-bold text-stone-400 uppercase">
                        <User size={12} className="text-[#E7A35F]" />
                        <span>By {article.author.split(" ")[0]}</span>
                      </div>

                      <button
                        onClick={() => setActiveArticle(article)}
                        className="text-[10px] uppercase tracking-widest font-bold font-mono text-stone-950 hover:text-[#E7A35F] transition-colors inline-flex items-center space-x-1 cursor-pointer group"
                      >
                        <span>Read More</span>
              ...
              <button
                ...
                className={`w-10 h-10 rounded-full flex items-center justify-center border transition-all duration-300 ${
                  currentPage === 1
                    ...
                    : "border-stone-200 text-stone-700 hover:border-[#E7A35F] hover:text-[#E7A35F] cursor-pointer"
                }`}
                title="Previous Page"
              >
                <ChevronLeft size={16} />
                ...
                return (
                  <button
                    ...
                    className={`w-10 h-10 font-mono text-xs font-bold transition-all duration-300 rounded-full cursor-pointer ${
                      currentPage === pageNum
                        ? "bg-stone-950 text-[#E7A35F] border border-stone-950 shadow-md scale-95"
                        : "bg-white text-stone-600 border border-stone-200/60 hover:border-[#E7A35F] hover:text-stone-950"
                    }`}
                  >
                    {pageNum}
                  </button>
      ...
      {/* ==================================================== */}
      <section className="py-24 bg-[#E2D8A5] border-t border-b border-stone-100" id="popular-topics">
        <div className="max-w-8xl mx-auto px-6 md:px-12">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <h2 className="text-3xl md:text-5xl font-light tracking-tight text-stone-900 uppercase">
              Popular <span className="font-serif italic text-[#E7A35F] font-normal lowercase">Topics</span>
            </h2>
            ...
            {popularTopics.map((topic, idx) => {
              ...
              return (
                <div
                  ...
                  className="bg-white border border-stone-200/40 p-6 rounded-2xl text-left space-y-4 hover:shadow-lg hover:border-[#E7A35F]/30 transition-all duration-300 group cursor-pointer flex flex-col justify-between"
                >
                  <div className="space-y-4">
                    <div className="w-10 h-10 rounded-xl bg-[#E2D8A5] border border-stone-200/30 flex items-center justify-center text-[#E7A35F] group-hover:bg-[#E7A35F]/10 transition-colors">
                      <IconComponent size={18} />
                    </div>
                    <div className="space-y-1">
                      <h3 className="text-sm font-bold uppercase tracking-wider text-stone-950 group-hover:text-[#E7A35F] transition-colors">
                        {topic.name}
                      </h3>
                  ...
                  <div className="pt-4 border-t border-stone-50 flex justify-between items-center text-[10px] font-mono text-stone-400 font-bold uppercase tracking-widest">
                    ...
                    <ChevronRight size={12} className="text-[#E7A35F] group-hover:translate-x-1 transition-transform" />
                  </div>
                </div>
              );
            })}
      ...
      <section className="py-24 bg-white border-b border-stone-100" id="why-read">
        <div className="max-w-8xl mx-auto px-6 md:px-12">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <h2 className="text-3xl md:text-5xl font-light tracking-tight text-stone-900 uppercase">
              Why Read <span className="font-serif italic text-[#E7A35F] font-normal lowercase">Our</span> Journal?
            </h2>
            <p className="text-stone-500 font-light text-sm sm:text-base leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {valueCards.map((card, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-[#E2D8A5] border border-stone-200/40 p-8 rounded-2xl text-left space-y-4 hover:bg-white hover:shadow-xl hover:border-[#E7A35F]/20 transition-all duration-500"
                >
                  <div className="w-12 h-12 rounded-xl bg-white border border-stone-200/30 flex items-center justify-center text-[#E7A35F] shadow-sm">
                    <IconComp size={20} />
                  </div>
      ...
      <section className="py-24 bg-stone-950 text-white relative overflow-hidden" id="newsletter">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center space-y-8 relative z-10">
          <div className="w-14 h-14 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-[#E7A35F] mx-auto mb-4">
            <Mail size={22} className="animate-pulse" />
          </div>

          <div className="space-y-3">
            <span className="text-[#E7A35F] text-xs tracking-[0.25em] font-mono font-bold block uppercase">
              WEEKLY DIGEST
            </span>
            <h2 className="text-4xl sm:text-5xl font-light tracking-tight text-white uppercase leading-none">
              Stay <span className="font-serif italic text-[#E7A35F] font-normal lowercase">Inspired.</span>
            </h2>
          ...
          <AnimatePresence mode="wait">
            {!newsletterSubmitted ? (
              ...
              >
                <div className="flex flex-col sm:flex-row gap-3">
                  <input
                    ...
                    className="flex-1 px-5 py-3.5 bg-stone-900 border border-white/10 text-white placeholder-stone-500 text-xs sm:text-sm focus:outline-none focus:ring-1 focus:ring-[#E7A35F] focus:border-[#E7A35F]"
                  />
                  <button
                    type="submit"
                    className="px-6 py-3.5 bg-[#E7A35F] hover:bg-[#6F9F9C] text-stone-950 font-bold text-xs uppercase tracking-widest transition-colors cursor-pointer whitespace-nowrap"
                  >
                    Subscribe
                  </button>
                </div>
              ...
              >
                <div className="w-12 h-12 rounded-full bg-[#E7A35F]/10 border border-[#E7A35F]/30 flex items-center justify-center text-[#E7A35F] mx-auto">
                  <Check size={20} strokeWidth={3} className="animate-bounce" />
                </div>
                <div className="space-y-1">
                  <h4 className="text-[#E7A35F] text-sm uppercase font-mono font-bold tracking-widest">
                    Thank You!
                  </h4>
      ...
      {/* FINAL CTA                                            */}
      {/* ==================================================== */}
      <section className="relative w-full overflow-hidden py-24 md:py-32 bg-[#E2D8A5]" id="final-cta">
        <div className="absolute inset-0 z-0 opacity-[0.03]">
          <div className="h-full w-full bg-[radial-gradient(#E7A35F_1px,transparent_1px)] [background-size:16px_16px]" />
        </div>
        ...
        <div className="max-w-8xl mx-auto px-6 md:px-12 relative z-10 text-center space-y-8">
          <div className="space-y-4 max-w-4xl mx-auto">
            ...
            <h2 className="text-4xl sm:text-5xl md:text-7xl font-light tracking-tight text-stone-900 leading-tight uppercase">
              ...
              <span className="font-serif italic text-[#E7A35F] font-normal lowercase">Your</span> Space?
            </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <button
              onClick={handleOpenConsultation}
              className="w-full sm:w-auto inline-flex items-center justify-center space-x-3 text-stone-900 font-bold text-xs tracking-widest uppercase transition-all duration-300 bg-[#E7A35F] hover:bg-[#6F9F9C] px-8 py-4.5 rounded-none cursor-pointer"
            >
            ...
            >
              ...
              <div className="w-full aspect-[2/1] bg-stone-100 overflow-hidden relative">
                ...
                <div className="absolute bottom-6 left-6 right-6 text-white space-y-2">
                  <span className="bg-[#E7A35F] text-stone-950 font-mono text-[9px] font-black uppercase tracking-widest px-2.5 py-1.5 shadow">
              ...
              <div className="p-6 md:p-12 space-y-8 flex-1">
                ...
                <div className="flex flex-wrap items-center gap-6 pb-6 border-b border-stone-100 text-stone-400 font-mono text-[10px] tracking-wider uppercase font-bold">
                  <div className="flex items-center space-x-2 text-stone-600">
                    <User size={13} className="text-[#E7A35F]" />
                  ...
                  <div className="flex items-center space-x-2 text-stone-600">
                    <Clock size={13} className="text-[#E7A35F]" />
                ...
                <div className="prose prose-stone prose-sm sm:prose-base max-w-none text-stone-700 font-light leading-relaxed space-y-6">
                  {activeArticle.content.split("\n\n").map((para, i) => {
                    if (para.startsWith("###")) {
                      return (
                        <h3 key={i} className="text-lg md:text-xl font-serif font-bold text-stone-950 pt-6 border-l-2 border-[#E7A35F] pl-4 uppercase tracking-tight">
                          {para.replace("### ", "")}
                        </h3>
                      );
                    }
                ...
                <div className="bg-[#E2D8A5] border border-stone-200/50 p-6 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-6 mt-16 text-center md:text-left">
                  <div className="space-y-1">
                    <span className="text-[#E7A35F] text-[10px] tracking-widest font-mono font-bold uppercase flex items-center justify-center md:justify-start gap-1">
                  ...
                  <button
                    ...
                    className="w-full md:w-auto px-6 py-3.5 bg-stone-950 hover:bg-[#E7A35F] hover:text-stone-950 text-white font-bold text-xs uppercase tracking-widest transition-colors rounded-none cursor-pointer shrink-0"
                  >
