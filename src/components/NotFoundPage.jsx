      ...
      <section className="relative min-h-[75vh] flex items-center bg-stone-950 text-white overflow-hidden py-16" id="not-found-hero">
        ...
        <div className="absolute right-0 bottom-0 top-0 w-full lg:w-1/2 opacity-25 lg:opacity-75 pointer-events-none z-0 overflow-hidden">
          <div className="relative w-full h-full flex items-center justify-center">
            ...
            <svg 
              className="w-[120%] h-[120%] text-primary/30 shrink-0 select-none"
              viewBox="0 0 800 800" 
              fill="none" 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              >
                ...
                <span className="font-serif italic text-primary font-normal lowercase">Hasn't Been Designed</span> Yet.
              </motion.h1>
      ...
      <section className="py-24 max-w-8xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="text-center sm:text-left space-y-3 mb-16">
          ...
          <h3 className="text-2xl sm:text-3xl font-serif font-light uppercase text-stone-900 tracking-tight">
            Select Your Next <span className="font-serif italic text-primary lowercase">destination</span>
          </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r from-primary/10 via-primary to-primary/10 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500" />
            
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-full bg-stone-50 border border-stone-200/50 flex items-center justify-center text-primary group-hover:bg-stone-950 group-hover:text-white transition-colors duration-300">
                <Compass size={20} />
              </div>
              <div className="space-y-2">
                <h4 className="text-lg font-serif font-bold text-stone-950 uppercase group-hover:text-primary transition-colors duration-300">
            ...
            <div className="pt-4">
              <button
                ...
                className="inline-flex items-center space-x-2 text-stone-950 font-bold text-xs tracking-widest uppercase transition-colors group-hover:text-primary cursor-pointer"
              >
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-4">
            {[
              ...
              <button
                ...
                className="text-stone-600 hover:text-primary transition-colors font-mono text-xs uppercase tracking-wider cursor-pointer font-bold relative group py-1"
              >
                <span>{link.label}</span>
                <span className="absolute bottom-0 left-0 w-full h-[1px] bg-primary transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300" />
              </button>
            ))}
          </div>
      ...
      <section className="bg-stone-950 text-white py-24 relative overflow-hidden" id="not-found-cta">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center space-y-8 relative z-10">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-light tracking-tight text-white leading-tight uppercase max-w-3xl mx-auto">
            ...
            <span className="font-serif italic text-primary font-normal lowercase">Beautiful Together.</span>
          </h2>
