      ...
      <section className="relative min-h-[60vh] flex items-center bg-stone-950 text-white overflow-hidden py-16" id="thank-you-hero">
        ...
        <div className="absolute right-0 bottom-0 top-0 w-full lg:w-1/2 opacity-20 lg:opacity-60 pointer-events-none z-0 overflow-hidden">
          <div className="relative w-full h-full flex items-center justify-center">
            ...
            <svg 
              className="w-[120%] h-[120%] text-[#E7A35F]/20 shrink-0 select-none"
              viewBox="0 0 800 800" 
              fill="none" 
        ...
        <div className="max-w-8xl mx-auto px-6 md:px-12 relative z-10 w-full">
          <div className="max-w-3xl space-y-8">
            ...
            >
              {/* Ring pulse glow */}
              <span className="absolute inset-0 rounded-full bg-[#E7A35F]/10 border border-[#E7A35F]/20 animate-ping opacity-75" />
              <div className="relative w-20 h-20 rounded-full bg-stone-900 border border-[#E7A35F]/40 flex items-center justify-center text-[#E7A35F] shadow-2xl">
                <motion.div
            ...
            <div className="space-y-3">
              <div className="inline-flex items-center space-x-2 bg-stone-900 border border-white/5 rounded-full px-4 py-1.5">
                ...
                <span className="text-[#E7A35F] text-[10px] md:text-xs font-mono tracking-[0.3em] font-bold uppercase">
                  REQUEST RECEIVED
                </span>
              </div>
              ...
              >
                Thank You For <br />
                <span className="font-serif italic text-[#E7A35F] font-normal lowercase">Getting In</span> Touch.
              </motion.h1>
            </div>
        ...
        <div className="max-w-8xl mx-auto px-6 md:px-12">
          ...
          <div className="text-center sm:text-left space-y-3 mb-16 max-w-2xl">
            ...
            <h2 className="text-2xl sm:text-4xl font-serif font-light uppercase text-stone-900 tracking-tight">
              Next Steps &amp; <span className="font-serif italic text-[#E7A35F] lowercase">project</span> Milestones
            </h2>
          ...
          <div className="relative pt-4">
            ...
            <div className="absolute top-[40px] left-12 right-12 h-[2px] bg-stone-100 hidden lg:block z-0">
              <motion.div 
                ...
                className="h-full bg-gradient-to-r from-[#E7A35F] via-[#E7A35F] to-stone-200"
              />
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="lg:mb-6 shrink-0 relative">
                      <div className={`w-14 h-14 rounded-full flex items-center justify-center transition-all duration-300 ${
                        step.status === "completed" 
                          ? "bg-[#E7A35F] text-stone-900 shadow-[0_0_15px_rgba(231,163,95,0.4)]"
                          : step.status === "active"
                          ? "bg-stone-900 text-[#E7A35F] border-2 border-[#E7A35F] animate-pulse"
                          : "bg-stone-50 border border-stone-200 text-stone-400 group-hover:border-[#E7A35F]/50"
                      }`}>
                    ...
                    <div className="space-y-1.5 pt-1 lg:pt-0">
                      <div className="flex items-center space-x-2">
                        <span className="text-[10px] font-mono font-bold text-[#E7A35F]">0{idx + 1}</span>
                        <h4 className="text-sm font-bold text-stone-900 uppercase tracking-wider group-hover:text-[#E7A35F] transition-colors duration-300">
                          {step.title}
                        </h4>
                      </div>
                      ...
                      {step.status === "completed" && (
                        <span className="inline-flex text-[9px] font-mono font-bold text-[#E7A35F] uppercase tracking-wider bg-[#E7A35F]/10 px-2 py-0.5 rounded-full">
                          COMPLETED
                        </span>
                      )}
                      {step.status === "active" && (
                        <span className="inline-flex text-[9px] font-mono font-bold text-[#E7A35F] uppercase tracking-wider bg-[#E7A35F]/10 px-2 py-0.5 rounded-full animate-pulse">
                          IN PROGRESS
                        </span>
                      )}
                    </div>
              ...
              >
                <div className="space-y-6">
                  ...
                  <div className={`w-12 h-12 rounded-2xl flex items-center justify-center ${
                    isDark ? "bg-white/10 text-[#E7A35F]" : "bg-stone-50 border border-stone-200/50 text-[#E7A35F]"
                  }`}>
                    <Icon size={20} />
                  </div>
                ...
                <div className="pt-6">
                  {card.detail && (
                    <a 
                      href={card.link}
                      className="font-mono text-sm font-semibold text-[#E7A35F] hover:underline flex items-center space-x-1"
                    >
                  ...
                  {card.link && !card.detail && (
                    <a 
                      ...
                      className="inline-flex items-center space-x-1.5 text-stone-900 hover:text-[#E7A35F] text-xs font-mono font-bold uppercase tracking-wider"
                    >
                  ...
                  {card.action === "view-projects" && (
                    <button
                      ...
                      className="inline-flex items-center space-x-1.5 text-[#E7A35F] hover:text-white text-xs font-mono font-bold uppercase tracking-wider cursor-pointer"
                    >
        ...
        <div className="max-w-8xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
            ...
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center space-x-2 px-8 py-4 border border-stone-300 text-stone-900 text-xs font-mono tracking-[0.2em] uppercase font-bold transition-all duration-300 bg-white hover:border-[#E7A35F] hover:text-[#E7A35F] cursor-pointer shadow-sm"
            >
              <Home size={14} />
            ...
            >
              <Compass size={14} className="text-[#E7A35F]" />
