      ...
      <section className="relative py-20 bg-stone-950 text-white overflow-hidden" id="privacy-hero">
        ...
        <div className="max-w-8xl mx-auto px-6 md:px-12 relative z-10 w-full">
          ...
          <div className="max-w-3xl space-y-5">
            ...
            >
              Privacy <span className="font-serif italic text-primary font-normal lowercase">Policy</span>
            </motion.h1>
            <motion.p
          ...
          <div className="lg:col-span-8 space-y-16">
            ...
            <div ref={sectionRefs["info-use"]} className="bg-white rounded-3xl border border-stone-200/40 p-8 md:p-12 shadow-sm space-y-8 relative overflow-hidden" id="info-use">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={idx} className="flex items-start space-x-3 p-4 bg-field/40 border border-stone-200/20 rounded-xl">
                    <div className="w-5 h-5 rounded-full bg-stone-900 text-primary flex items-center justify-center text-[10px] shrink-0 mt-0.5">
            ...
            <div ref={sectionRefs["info-sharing"]} className="bg-white rounded-3xl border border-stone-200/40 p-8 md:p-12 shadow-sm space-y-6 relative overflow-hidden" id="info-sharing">
              ...
              <div className="p-6 bg-stone-50 border border-stone-100 rounded-2xl border-l-4 border-l-stone-900">
                <p className="text-stone-900 font-serif italic text-sm md:text-base leading-relaxed">
            ...
            <div ref={sectionRefs["cookies"]} className="bg-white rounded-3xl border border-stone-200/40 p-8 md:p-12 shadow-sm space-y-8 relative overflow-hidden" id="cookies">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  ...
                  <div key={idx} className="p-5 border border-stone-100 rounded-2xl space-y-2.5 text-left bg-field/30">
                    <span className="text-[10px] font-mono font-bold text-primary tracking-wider uppercase block">TYPE 0{idx+1}</span>
                  ...
                  return (
                    <div key={idx} className="p-5 border border-stone-200/60 rounded-2xl flex items-start space-x-4 hover:border-primary transition-colors duration-300">
                      ...
                      <div className="space-y-1">
                        ...
                        <span className="text-primary text-[10px] font-mono font-bold block">{card.label}</span>
      ...
      <section className="bg-stone-950 text-white py-24 relative overflow-hidden" id="privacy-cta">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center space-y-8 relative z-10">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-light tracking-tight text-white leading-tight uppercase max-w-3xl mx-auto">
            ...
            <span className="font-serif italic text-primary font-normal lowercase">Your Privacy?</span>
          </h2>
          ...
          <div className="pt-4">
            <button
              ...
              className="inline-flex items-center justify-center space-x-3 text-stone-950 font-bold text-xs tracking-widest uppercase transition-all duration-300 bg-primary hover:bg-lighter px-8 py-4.5 rounded-none cursor-pointer"
            >
