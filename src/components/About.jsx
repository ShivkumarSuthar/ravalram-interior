...
export default function About({ setView }) {
  ...
  return (
    <div id="about" className="bg-field py-24 md:py-32 overflow-hidden">
          ...
          <div className="lg:col-span-7 space-y-12">
            <motion.div variants={itemVariants} className="space-y-6">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-light tracking-tight text-stone-900 leading-[1.15] max-w-2xl text-left uppercase">
                Built on <span className="font-serif italic text-primary font-normal lowercase">Legacy</span>.<br />
                Designed for the <span className="font-serif italic text-primary font-normal lowercase">Future</span>.
              </h2>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="relative pt-4">
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-8 sm:gap-0">
                ...
                <div className="relative flex items-center select-none shrink-0">
                  <span className="text-[110px] sm:text-[140px] md:text-[180px] lg:text-[200px] font-serif font-light text-primary leading-none tracking-tighter">
                    30+
                  </span>
                ...
                <div className="w-full max-w-[280px] sm:w-64 aspect-[3/4] relative sm:-ml-8 md:-ml-12 mt-2 sm:mt-12 z-10 shadow-2xl rounded-none overflow-hidden border-4 border-field group">
                  <AppImage
                    src={loftImg}
            ...
            <motion.div variants={itemVariants} className="space-y-8">
              ...
              <div className="pt-2 text-left">
                <button
                  ...
                  className="inline-flex items-center space-x-4 text-stone-900 hover:text-primary font-bold text-xs tracking-[0.25em] uppercase transition-all duration-300 group cursor-pointer"
