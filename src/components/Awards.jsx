          ...
          <div className="lg:col-span-5 flex flex-col items-center lg:items-start text-center lg:text-left space-y-8">
            <div className="space-y-4">
              ...
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-light tracking-tight text-white leading-tight">
                Design That <span className="font-serif italic text-[#c5a880] font-normal">Speaks Our</span> Industry <span className="font-serif italic text-[#c5a880] font-normal">Awards</span>
              </h2>
            </div>
