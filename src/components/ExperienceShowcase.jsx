        ...
        >
          ...
          <div className="absolute bottom-6 left-6 right-6 sm:bottom-8 sm:left-8 sm:right-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-white text-left z-10">
            ...
            <button
              ...
              className="shrink-0 inline-flex items-center space-x-3 bg-gold-accent hover:bg-[var(--color-primary-hover)] text-stone-950 font-bold text-xs uppercase tracking-[0.18em] px-7 py-4 rounded-full transition-all duration-300 cursor-pointer shadow-2xl hover:scale-[1.03]"
            >
