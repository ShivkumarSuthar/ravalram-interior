      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="text-left mb-12 space-y-4">
          ...
          <h2 className="text-3xl md:text-5xl font-light tracking-tight text-stone-900 leading-tight uppercase">
            ...
            <span className="font-serif italic text-[#c5a880] font-normal lowercase">Crafted to</span> Last.
          </h2>
              ...
              >
                ...
                <div className="relative aspect-[16/10] bg-stone-900 rounded-none overflow-hidden border border-stone-200/20">
                  ...
                  <div className="absolute inset-0 bg-stone-950/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center z-10">
                    <div className="w-16 h-16 rounded-full bg-[#c5a880] text-stone-950 flex flex-col items-center justify-center shadow-2xl scale-90 group-hover:scale-100 transition-transform duration-500">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="space-y-2">
                    <h3 className="text-xl md:text-2xl font-serif text-stone-900 font-medium group-hover:text-[#c5a880] transition-colors duration-300">
                      {proj.title}
                    </h3>
                  ...
                  <div className="w-10 h-10 rounded-full border border-stone-200 flex items-center justify-center text-stone-800 group-hover:bg-[#c5a880] group-hover:text-stone-950 group-hover:border-[#c5a880] transition-all duration-300 shrink-0">
        ...
        >
          ...
          <div className="max-w-3xl relative z-10 space-y-6">
            ...
            <h3 className="text-2xl md:text-4xl font-light tracking-tight text-white leading-tight uppercase">
              Have a Vision? <br />
              <span className="font-serif italic text-[#c5a880] font-normal lowercase">Let's Bring It to</span> Life.
            </h3>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95 backdrop-blur-md">
            ...
            <div className="relative max-w-5xl max-h-[80vh] w-full px-6 flex items-center justify-center z-10 select-none">
              <button
                ...
                className="absolute left-10 p-3 text-white hover:text-[#c5a880] transition-colors duration-300 bg-white/5 hover:bg-white/10 rounded-full cursor-pointer"
              ...
              <button
                ...
                className="absolute right-10 p-3 text-white hover:text-[#c5a880] transition-colors duration-300 bg-white/5 hover:bg-white/10 rounded-full cursor-pointer"
            ...
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-10 text-center text-white space-y-1">
              ...
              <p className="text-xs text-[#c5a880] uppercase tracking-widest font-mono">{filteredProjects[lightboxIndex].category}</p>
            </div>
          </div>
        )}
      </AnimatePresence>
