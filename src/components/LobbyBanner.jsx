    ...
    <section className="relative w-full h-[50vh] md:h-[65vh] overflow-hidden bg-stone-950 flex items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center">
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="w-20 h-20 rounded-full bg-white/10 hover:bg-[#E7A35F]/20 backdrop-blur-md flex items-center justify-center text-white border border-white/20 hover:border-[#E7A35F]/40 shadow-2xl transition-all duration-500 cursor-pointer group"
          aria-label="Play Studio Documentary"
        >
          <svg
            className="w-5 h-5 fill-current translate-x-0.5 text-white group-hover:text-[#E7A35F] transition-colors duration-500"
            viewBox="0 0 24 24"
          >
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-stone-950/95 backdrop-blur-md p-4">
            ...
            >
              ...
              <button
                ...
                className="absolute top-4 right-4 bg-black/80 backdrop-blur-md text-white p-2 border border-white/10 hover:text-[#E7A35F] transition-colors z-20 cursor-pointer"
              >
