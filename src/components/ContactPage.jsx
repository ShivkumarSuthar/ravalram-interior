...
export default function ContactPage({ onBackToHome, onOpenQuote, setView }) {
  ...
  const contactMethods = [
    {
      ...
      icon: Phone,
      color: "bg-[#E7A35F]/10 text-[#E7A35F]"
    },
    {
      title: "Email",
      action: "Send Email",
  ...
  return (
    <div className="bg-[#E2D8A5] text-stone-900 font-sans selection:bg-[#E7A35F]/30 selection:text-stone-950 pt-[80px]">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-stone-950 text-white">
        ...
        <div className="max-w-8xl mx-auto px-6 md:px-12 relative z-20 w-full text-left space-y-8 py-20">
          <div className="inline-flex items-center space-x-2 text-stone-400 text-xs tracking-[0.25em] font-mono uppercase">
            ...
            <span>/</span>
            <span className="text-[#E7A35F] font-bold">CONTACT US</span>
          </div>
          ...
          <div className="space-y-4 max-w-4xl">
            ...
            >
              Let's Bring Your <br />
              <span className="font-serif italic text-[#E7A35F] font-normal lowercase">Vision To</span> Life.
            </motion.h1>
            <motion.p
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center justify-center px-6 py-4 border border-white/20 text-white text-xs font-mono tracking-[0.2em] uppercase font-bold transition-all duration-300 rounded-none bg-white/5 backdrop-blur-md cursor-pointer hover:border-[#E7A35F] hover:text-[#E7A35F] text-center"
            >
              Call Our Team
            </a>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center mb-16">
            <div className="lg:col-span-5 text-left space-y-4">
              ...
              <h2 className="text-3xl md:text-5xl font-light tracking-tight text-stone-900 leading-tight uppercase">
                We're Here <br />
                <span className="font-serif italic text-[#E7A35F] font-normal lowercase">To</span> Help.
              </h2>
            </div>
            ...
            {contactMethods.map((method, idx) => {
              ...
              return (
                <motion.a
                  ...
                  className="bg-[#E2D8A5] border border-stone-200/50 hover:border-[#E7A35F]/40 p-6 rounded-2xl text-left block space-y-4 hover:shadow-xl transition-all duration-300 group"
                >
                  ...
                  <div className="space-y-1">
                    ...
                    <h3 className="text-sm font-semibold uppercase tracking-wider text-stone-950 group-hover:text-[#E7A35F] transition-colors">
                      {method.action}
                    </h3>
                    <p className="text-[#E7A35F] font-mono text-xs font-semibold select-all pt-1 leading-tight">
                      {method.detail}
                    </p>
          ...
          <div className="mt-12 bg-stone-50 border border-stone-200/30 p-6 md:p-8 rounded-2xl text-left">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="space-y-2">
                <span className="text-[#E7A35F] text-[10px] uppercase font-mono tracking-widest block font-bold">
                  REGIONAL OUTREACH
                </span>
      ...
      <section className="py-24 md:py-32 bg-[#E2D8A5] relative overflow-hidden" id="showroom-map">
        <div className="max-w-8xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-5 text-left space-y-6 lg:sticky lg:top-[120px]">
              ...
              <h2 className="text-3xl md:text-5xl font-light tracking-tight text-stone-900 leading-tight uppercase">
                Tell Us About <br />
                <span className="font-serif italic text-[#E7A35F] font-normal lowercase">Your</span> Project.
              </h2>
              ...
              <div className="space-y-4 pt-4 border-t border-stone-200/50">
                <div className="flex items-center space-x-3 text-stone-700 text-xs font-mono">
                  <CheckCircle2 size={14} className="text-[#E7A35F]" />
            ...
            <div className="lg:col-span-7 bg-white border border-stone-200/50 p-8 md:p-12 rounded-3xl shadow-xl text-left">
              <AnimatePresence mode="wait">
                {!formSubmitted ? (
                  ...
                  >
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-stone-50 border border-stone-200 focus:border-[#E7A35F] focus:bg-white rounded-lg px-4 py-3 text-sm text-stone-900 outline-none transition-all duration-300"
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <select
                            ...
                            onChange={handleInputChange}
                            className="w-full bg-stone-50 border border-stone-200 focus:border-[#E7A35F] focus:bg-white rounded-lg px-4 py-3 text-sm text-stone-900 outline-none transition-all duration-300 appearance-none cursor-pointer"
                          >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleInputChange}
                        className="w-full bg-stone-50 border border-stone-200 focus:border-[#E7A35F] focus:bg-white rounded-lg px-4 py-3 text-sm text-stone-900 outline-none transition-all duration-300 resize-none"
                    ...
                    <div className="flex items-start space-x-3 pt-2">
                      <input
                        ...
                        onChange={handleInputChange}
                        className="mt-1 w-4 h-4 text-[#E7A35F] border-stone-300 rounded focus:ring-[#E7A35F] cursor-pointer"
                      />
                    ...
                    <div className="pt-4">
                      <button
                        type="submit"
                        className="w-full inline-flex items-center justify-center space-x-3 text-stone-900 font-bold text-xs tracking-widest uppercase transition-all duration-300 bg-[#E7A35F] hover:bg-[#6F9F9C] py-4 rounded-xl cursor-pointer shadow-lg"
                      >
                  ...
                  >
                    <div className="w-16 h-16 rounded-full bg-emerald-100 border border-emerald-500/30 flex items-center justify-center text-emerald-600 shadow-md">
                    ...
                    <div className="space-y-2 max-w-lg">
                      ...
                      <p className="text-stone-500 text-xs font-light">
                        Our lead design architects are analyzing your parameters (Approximate budget: <span className="font-medium text-stone-800">{formData.budget}</span> for <span className="font-medium text-[#E7A35F]">{formData.projectType}</span>). An architect will contact you within 1-2 hours on <span className="font-mono text-stone-800">{formData.phone}</span>.
                      </p>
                    </div>
        ...
        <div className="max-w-8xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24 space-y-4">
            ...
            <h2 className="text-3xl md:text-5xl font-light tracking-tight text-stone-900 uppercase">
              Why Connect <span className="font-serif italic text-[#E7A35F] font-normal lowercase">With</span> Suthar Studio
            </h2>
          </div>
      ...
      <section className="py-24 md:py-32 bg-[#E2D8A5] relative overflow-hidden">
        <div className="max-w-8xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24 space-y-4">
            ...
            <h2 className="text-3xl md:text-5xl font-light tracking-tight text-stone-900 uppercase">
              Our Project <span className="font-serif italic text-[#E7A35F] font-normal lowercase">Onboarding</span> Process
            </h2>
      ...
      <section className="py-24 md:py-32 bg-white relative overflow-hidden border-t border-b border-stone-100">
        <div className="max-w-8xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="text-left max-w-3xl mb-16 md:mb-24 space-y-4">
            ...
            <h2 className="text-3xl md:text-5xl font-light tracking-tight text-stone-900 uppercase">
              Our Geographical <span className="font-serif italic text-[#E7A35F] font-normal lowercase">Service</span> Areas
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {cities.map((city, idx) => (
              <div
                key={idx}
                className="bg-stone-50 border border-stone-200/50 p-6 rounded-xl text-left hover:shadow-xl hover:bg-white hover:border-[#E7A35F]/30 transition-all duration-500 group relative"
              >
          ...
          {/* Under Areas Message */}
          <div className="mt-12 text-center max-w-xl mx-auto space-y-3 bg-[#E2D8A5] border border-stone-200/50 p-6 rounded-xl">
            ...
            <div className="pt-2">
              <button
                onClick={handleOpenConsultation}
                className="inline-flex items-center space-x-2 text-stone-900 font-bold text-xs tracking-widest uppercase transition-colors hover:text-[#E7A35F] cursor-pointer border-b border-stone-950 pb-0.5"
              >
      ...
      <section className="py-24 bg-[#E2D8A5] relative overflow-hidden" id="showroom-address-grid">
        <div className="max-w-8xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center mb-12">
            <div className="lg:col-span-6 text-left space-y-4">
              ...
              <h2 className="text-3xl md:text-5xl font-light tracking-tight text-stone-900 uppercase">
                Visit Our <span className="font-serif italic text-[#E7A35F] font-normal lowercase">Showroom &amp;</span> Studio
              </h2>
            </div>
          ...
          <div className="relative w-full rounded-3xl overflow-hidden shadow-2xl border border-stone-200 bg-white p-4">
            <div className="w-full h-[400px] md:h-[480px] rounded-2xl overflow-hidden bg-stone-100 relative">
              ...
              <iframe
                ...
                className="w-full h-full border-none opacity-90 filter contrast-[0.95] saturate-[0.85]"
              ...
              <div className="absolute bottom-6 left-6 bg-stone-950 text-white p-6 rounded-2xl shadow-2xl text-left max-w-sm hidden md:block">
                <span className="text-[#E7A35F] text-[9px] font-mono tracking-widest font-bold uppercase block mb-1">HEADQUARTERS</span>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-[#E7A35F] text-xs font-bold tracking-widest uppercase hover:text-white transition-colors flex items-center space-x-1"
                >
      ...
      <section className="py-24 bg-white relative overflow-hidden border-b border-stone-100">
        <div className="max-w-8xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
            ...
            <h2 className="text-3xl md:text-5xl font-light tracking-tight text-stone-900 uppercase">
              Business <span className="font-serif italic text-[#E7A35F] font-normal lowercase">Hours &amp;</span> Access
            </h2>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8">
            <div className="bg-[#E2D8A5] border border-stone-200/50 p-6 md:p-8 rounded-2xl text-left space-y-3">
              <div className="w-10 h-10 rounded-xl bg-stone-950 text-[#E7A35F] flex items-center justify-center shadow-md">
                <Clock size={18} />
              </div>
              <h4 className="text-sm font-semibold uppercase tracking-wider text-stone-950">
                Monday – Saturday
              </h4>
              <p className="text-[#E7A35F] text-lg font-serif font-medium leading-none">
                9:00 AM – 7:00 PM
              </p>
      ...
      <section className="py-24 md:py-32 bg-white relative overflow-hidden border-b border-stone-100">
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16 md:mb-20 space-y-4">
            ...
            <h2 className="text-3xl md:text-5xl font-light tracking-tight text-stone-900 uppercase">
              Frequently <span className="font-serif italic text-[#E7A35F] font-normal lowercase">Asked</span> Questions
            </h2>
          </div>
        ...
        <div className="max-w-8xl mx-auto px-6 md:px-12 relative z-10 text-center space-y-8">
          <div className="space-y-4 max-w-4xl mx-auto">
            ...
            <h2 className="text-4xl sm:text-5xl md:text-7xl font-light tracking-tight text-white leading-tight uppercase">
              Let's Create <br />
              Something <span className="font-serif italic text-[#E7A35F] font-normal lowercase">Beautiful</span> Together.
            </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-5 border border-white/20 text-white text-xs font-bold tracking-widest uppercase transition-all duration-300 rounded-full bg-white/5 backdrop-blur-md cursor-pointer hover:border-[#E7A35F] hover:text-[#E7A35F] text-center"
            >
              WhatsApp Us
            </a>
          </div>
