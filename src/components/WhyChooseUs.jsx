...
export default function WhyChooseUs({ setView }) {
  ...
  return (
    <section id="why-choose-us" className="bg-field py-24 md:py-32 relative overflow-hidden border-t border-stone-200/50">
      <div className="max-w-8xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="text-left max-w-3xl mb-16 md:mb-24 space-y-4">
          ...
          <h2 className="text-3xl md:text-5xl font-light tracking-tight text-stone-900 leading-tight uppercase">
            Built on <span className="font-serif italic text-primary font-normal lowercase">Experience</span>.<br />
            Driven by <span className="font-serif italic text-primary font-normal lowercase">Trust</span>.
          </h2>
          ...
          {features.map((feat, idx) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -6 }}
                className="bg-white border border-stone-200/60 p-6 md:p-8 rounded-lg text-left space-y-6 hover:shadow-xl hover:border-primary/30 transition-all duration-500 flex flex-col justify-between group h-full"
              >
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-mono tracking-widest text-stone-300 font-bold group-hover:text-primary/50 transition-colors duration-500">
                      {feat.num}
                    </span>
                  </div>
        ...
        >
          ...
          <div className="absolute right-0 bottom-0 w-[40%] h-[100%] bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-primary/10 via-stone-950/0 to-stone-950/0 opacity-70 pointer-events-none" />
          ...
          <div className="max-w-3xl relative z-10 space-y-6">
            ...
            <h3 className="text-2xl md:text-4xl font-light tracking-tight text-white leading-tight uppercase">
              Let's Build <span className="font-serif italic text-primary font-normal lowercase">Something</span> <br />
              Extraordinary.
            </h3>
