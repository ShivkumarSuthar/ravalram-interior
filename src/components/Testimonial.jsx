...
export default function Testimonial({ setView }) {
  ...
  return (
    <section id="testimonials" className="bg-field py-24 md:py-32 relative overflow-hidden border-t border-stone-200/50">
      ...
      <div className="max-w-8xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="text-left max-w-3xl mb-16 md:mb-24 space-y-4">
          ...
          <h2 className="text-3xl md:text-5xl font-light tracking-tight text-stone-900 leading-tight uppercase">
            ...
            <span className="font-serif italic text-primary font-normal lowercase">Clients Who</span> Trust.
          </h2>
        ...
        >
          ...
          <div className="relative bg-white border border-stone-200/60 p-8 md:p-16 rounded-xl shadow-xl overflow-hidden min-h-[320px] flex flex-col justify-between">
            ...
            <div className="absolute right-0 top-0 w-[30%] h-[30%] bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-primary/5 via-white/0 to-white/0 pointer-events-none" />
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="flex items-center space-x-4 pt-6 border-t border-stone-100">
                  {/* Initials Avatar */}
                  <div className="w-12 h-12 rounded-full bg-stone-50 border border-stone-200 flex items-center justify-center font-mono font-bold text-sm text-primary">
                  ...
                  <div className="text-left">
                    ...
                    <span className="text-[10px] uppercase tracking-[0.15em] text-primary font-bold font-mono block">
                ...
                {testimonials.map((_, idx) => (
                  <button
                    ...
                    className={`h-1.5 transition-all duration-500 rounded-full cursor-pointer ${
                      currentIndex === idx ? "w-8 bg-primary" : "w-2 bg-stone-200 hover:bg-stone-300"
                    }`}
        ...
        >
          ...
          <div className="max-w-3xl relative z-10 space-y-6">
            ...
            <h3 className="text-2xl md:text-4xl font-light tracking-tight text-white leading-tight uppercase">
              ...
              <span className="font-serif italic text-primary font-normal lowercase">Our Next Success</span> Story.
            </h3>
