  ...
  return (
    <div className="bg-field text-stone-900 font-sans selection:bg-primary/30 selection:text-stone-950 pt-[80px]">
      ...
      <section className="py-24 bg-stone-950 text-white relative overflow-hidden">
        ...
        <div className="absolute right-0 bottom-0 w-[40%] h-[100%] bg-[radial-gradient(ellipse_at_bottom_right,_rgba(231,163,95,0.08),_transparent_70%)] pointer-events-none" />
