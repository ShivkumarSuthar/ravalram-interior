...
// Local asset imports
import coastalImg from "/assets/images/AI_images/antra_project_coastal_1782744299850.jpg";
import loftImg from "/assets/images/AI_images/antra_project_loft_1782744318019.jpg";
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-stone-950 text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-20 w-full text-left space-y-8 py-20">
          <div className="inline-flex items-center space-x-2 text-stone-400 text-xs tracking-[0.25em] font-mono uppercase">
            ...
            <span>/</span>
            <span className="text-[#CAA05C] font-bold">SERVICES</span>
          </div>
          ...
          <div className="space-y-4 max-w-4xl">
            ...
            >
              ...
              <span className="text-[#CAA05C]">Architectural</span> Solutions.
            </motion.h1>
            <motion.p
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-5 text-left space-y-4">
              ...
              <h2 className="text-3xl md:text-6xl font-light tracking-tight text-stone-900 leading-tight uppercase">
                ...
                <span className="text-[#CAA05C]">Under One</span> Roof.
              </h2>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-24 md:space-y-32 relative z-10">
          ...
          <div className="text-center max-w-2xl mx-auto space-y-4">
            ...
            <h2 className="text-3xl md:text-6xl font-light tracking-tight text-stone-900 uppercase">
              Our Core <span className="text-[#CAA05C]">Creative</span> Offerings
            </h2>
          </div>
            ...
            return (
              ...
              >
                ...
                <div className={`lg:col-span-6 text-left space-y-6 ${isEven ? "" : "lg:order-1"}`}>
                  <span className="text-[#CAA05C] text-xs font-mono font-bold tracking-[0.2em] uppercase block">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {service.features.map((feature, idx) => (
                        <div key={idx} className="flex items-center space-x-2 text-stone-800">
                          <CheckCircle2 size={14} className="text-[#CAA05C] shrink-0" />
                  ...
                  <div className="pt-4">
                    <button
                      onClick={onOpenQuote}
                      className="inline-flex items-center space-x-3 text-stone-900 font-bold text-xs tracking-widest uppercase transition-all duration-300 border-b-2 border-stone-900 hover:border-[#CAA05C] hover:text-[#CAA05C] pb-1 cursor-pointer"
                    >
      ...
      <section className="py-24 md:py-32 bg-white relative overflow-hidden border-t border-b border-stone-100">
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24 space-y-4">
            ...
            <h2 className="text-3xl md:text-6xl font-light tracking-tight text-stone-900 uppercase">
              How We <span className="text-[#CAA05C]">Work With</span> You
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {executionModels.map((model, idx) => (
              <motion.div
                ...
                className="bg-[#faf9f6] border border-stone-200/50 hover:border-[#CAA05C]/30 hover:shadow-xl hover:-translate-y-1 p-6 md:p-8 rounded-2xl text-left space-y-4 transition-all duration-500 group"
              >
                <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center border border-stone-200/30 text-[#CAA05C] font-mono font-bold text-xs shadow-sm">
                  0{idx + 1}
                </div>
      ...
      <section className="py-24 md:py-32 bg-[#faf9f6] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24 space-y-4">
            ...
            <h2 className="text-3xl md:text-6xl font-light tracking-tight text-stone-900 uppercase">
              Our Design &amp; <span className="text-[#CAA05C]">Execution</span> Process
            </h2>
      ...
      <section className="py-24 md:py-32 bg-white relative overflow-hidden border-t border-b border-stone-100">
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24 space-y-4">
            ...
            <h2 className="text-3xl md:text-6xl font-light tracking-tight text-stone-900 uppercase">
              Why Clients <span className="text-[#CAA05C]">Trust</span> Suthar Studio
            </h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="text-left max-w-3xl mb-16 md:mb-20 space-y-4">
            ...
            <h2 className="text-3xl md:text-6xl font-light tracking-tight text-white uppercase">
              Industries <span className="text-[#CAA05C]">We</span> Serve
            </h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {industries.map((ind, idx) => (
              <motion.div
                ...
                className="bg-white/5 border border-white/10 p-6 rounded-xl hover:bg-white/10 hover:border-[#CAA05C]/40 transition-all duration-300 text-left relative group cursor-default"
              >
                <div className="text-stone-500 font-mono text-[10px] group-hover:text-[#CAA05C] transition-colors block mb-4">
                  {ind.count}
                </div>
                <h4 className="text-sm sm:text-base font-serif font-light tracking-wide text-white group-hover:text-[#CAA05C] transition-colors">
                  {ind.name}
                </h4>
              </motion.div>
            ))}
      ...
      <section className="py-24 md:py-32 bg-[#faf9f6] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="text-left max-w-3xl mb-16 md:mb-24 space-y-4">
            ...
            <h2 className="text-3xl md:text-6xl font-light tracking-tight text-stone-900 uppercase">
              Service <span className="text-[#CAA05C]">Areas &amp;</span> Locations
            </h2>
            <p className="text-stone-600 font-light text-sm sm:text-base leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {cities.map((city, idx) => (
              <div
                key={idx}
                className="bg-white border border-stone-200/50 p-6 rounded-xl text-left hover:shadow-xl hover:border-[#CAA05C]/30 transition-all duration-500 group relative"
              >
      ...
      <section className="py-24 md:py-32 bg-white relative overflow-hidden border-t border-b border-stone-100">
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16 md:mb-20 space-y-4">
            ...
            <h2 className="text-3xl md:text-6xl font-light tracking-tight text-stone-900 uppercase">
              Service <span className="text-[#CAA05C]">Insights &amp;</span> FAQ
            </h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 text-center space-y-8">
          <div className="space-y-4 max-w-4xl mx-auto">
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-light tracking-tight text-white leading-tight uppercase">
              Let's Build Your <span className="text-[#CAA05C]">Dream</span> Space.
            </h2>
